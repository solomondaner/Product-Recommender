# Read Data into Microsoft Azure----
# Map 1-based optional input ports to variables
sales_data <- maml.mapInputPort(1) # class: data.frame

# Upload Packages that do not come with Microsoft Azure----
install.packages("src/recommenderlab.zip", lib = ".", repos = NULL, verbose = TRUE)
library(recommenderlab, lib.loc=".", verbose=TRUE)

# Load Packages that are part of Microsoft Azure----
library(data.table)
...
# Export data into the output Dataset port----
